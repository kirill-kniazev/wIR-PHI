...
Next, enter the sample name and click **Collect and Save Spectra** to start the hyperspectral image collection. The data will be saved automatically. For analysis of hyperspectral images, please refer to the GitHub repository [kirill-kniazev/Hyperspectral Image Analysis](https://github.com/kirill-kniazev/Hyperspectral-Image-Analysis).
